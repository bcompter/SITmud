...
/**
 * Allows a player to flex
 * The String following the Flex command is displayed
...
public class Flex implements Command
{
	public void execute(Mobile thisMobile, String args)
	{
		...
		else
		{
			...
			{
				toRoom = thisMobile.nameToString() + " flexes their muscles.";
				toPlayer = "You flex your muscles.";
				if (thisMobile.isPlayer())
				{
			...
			{
				toRoom = thisMobile.nameToString() + " flexes";
				toPlayer = "You flex";
